...
namespace Oddmatics.RozWorld.API.Generic.Level
{
    ...
    public struct WorldLocation
    {
        ...
        public WorldLocation(double localX, double localY, int segX, int segY, int segZ) : this()
        {
            LocalX = localX;
            LocalY = localY;
            SegmentX = segX;
        ...
        public WorldLocation(double localX, double localY, int segX, int segY, int segZ, IWorld world) : this()
        {
            LocalX = localX;
            LocalY = localY;
            SegmentX = segX;
